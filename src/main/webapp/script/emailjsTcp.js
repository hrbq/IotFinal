...
navigator.tcpPermission.requestPermission({remoteAddress:"127.0.0.1", remotePort:6789}).then(
  function(){
    ...
    mySocket.opened.then(
      ...
      console.error("TCP connection setup failed due to error: ", e);
    );
    ...
    mySocket.closed.then(
      ...
      console.error("TCP socket closed due to error: ", e);
    );
  },
  console.error("Connection to 127.0.0.1 on port 6789 was denied
                     due to error: ", e);
);